...
highschool_of_the_dead = Anime.create(name: "Highschool of the Dead", description: "Post-Apocolyptic/Fan Service")
...
naruto = Anime.create(name: "naruto", description: "shounen")
#User
